          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 items-start sm:items-center z-10 w-full sm:w-auto">
            <div className='z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-4 w-full sm:w-auto'>
              ...
              <Button
                label="Get started"
                href="/home"
                className="z-10 transition duration-300 shadow-lg hidden sm:flex hover:shadow-xl sm:w-auto"
              />
            </div>
          </div>
        </div>

        <div className="flex w-full flex-col lg:flex-row justify-between items-center gap-10 lg:gap-0 z-10 sm:mt-16 md:mt-8 lg:mt-0">
          <div className="flex flex-col gap-4 sm:gap-5 w-full items-center lg:items-start z-10 text-center lg:text-left">
