...
export default function Home() {
  return (
    <main className="relative w-full min-h-screen bg-black text-white overflow-hidden flex flex-col items-center justify-center">
      <section className="relative w-full min-h-screen px-44 flex flex-col items-center justify-center">
        {/* Background layers */}
        ...
        {/* Guide lines */}
        <div className="absolute top-24 left-24 w-[0.05rem] h-full bg-neutral-900" />
        <div className="absolute bottom-18 left-0 w-full h-[0.05rem] bg-neutral-900" />
        <div className="absolute right-24 top-0 h-full w-[0.05rem] bg-neutral-900" />

        {/* Header row */}
        <div className="absolute top-8 left-0 w-full px-44 flex justify-between items-end z-10">
          <Link href="/">
            <span className="text-3xl font-medium font-mono">OSSean</span>
          </Link>
          <div className="flex gap-4 items-center z-10">
            ...
            <div className='z-10 flex justify-between items-center gap-4'>
              <Link
                ...
                className="group relative z-50 ml-auto flex w-full max-w-[15.3rem] items-center justify-center gap-2 whitespace-pre rounded-none border border-input border-neutral-700 bg-transparent px-4 py-2 text-sm font-medium text-black shadow-sm transition-all duration-300 ease-out hover:bg-accent hover:text-accent-foreground overflow-hidden hover:ring-black dark:text-white md:flex"
              >
                ...
                <div className="ml-2 flex items-center gap-2 text-sm md:flex">
                  ...
                  <span className="inline-block font-mono pr-2 font-medium tabular-nums tracking-wider text-black dark:text-white">
                    0.001k+
                  </span>
                </div>
              </Link>
        ...
        <div className="flex w-full justify-between items-center z-10">
          <div className="flex flex-col gap-5 w-full items-start z-10">
            <div className="text-left text-3xl sm:text-5xl font-medium leading-[100%] animate-fade-in w-fit">
              ...
              <div
                className="mt-3 px-2 py-1 w-fit text-sm font-medium text-neutral-500 tracking-tight border-[2px] transition duration-300"
                style={{
                  borderImage:
            ...
            <div className="text-neutral-400 font-medium leading-5 transition duration-300">
              <p>
          ...
          {/* Right visual map */}
          <div className="w-full h-[22.5rem] bg-[url('/worldMap.svg')] bg-cover bg-top opacity-70 pointer-events-none z-10" />
        </div>
      </section>
    </main>
  );
