...
export default function GithubButton() {
    return (
        <Link
            ...
            className="group relative z-50 flex items-center justify-between gap-2 w-fit sm:w-auto max-w-full sm:max-w-[15rem] whitespace-pre border border-neutral-700/60 p-2 text-xs sm:text-sm font-mono text-white hover:text-yellow-300 transition-all duration-300 ease-out hover:shadow-md rounded-xs"
        >
