    ...
    <div className="flex w-full bg-black min-h-screen items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-[280px] mx-auto px-8">
        ...
        <button
          ...
          className="w-full h-11 px-4 cursor-pointer bg-white text-black text-sm font-normal tracking-normal disabled:opacity-40 disabled:cursor-not-allowed focus:outline-none focus-visible:ring-2 focus-visible:ring-black/10 transition-colors border border-black/10 shadow-sm hover:bg-white/95 flex items-center justify-center gap-3"
        >
          {loading ? (
            <div className="animate-spin h-4 w-4 border border-gray-400 border-t-black rounded-full" />
          ) : (
