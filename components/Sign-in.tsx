...
//                     alert('Connection refused. Please make sure the server is running on http://localhost:3000');
//                 } else {
...
//             <div className="absolute inset-0 z-0 bg-[url('/authBg.png')] opacity-50 bg-cover bg-center pointer-events-none" />
